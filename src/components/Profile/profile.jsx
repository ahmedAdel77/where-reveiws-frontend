              ...
              <Row>
                <Col>
                  <Row>
                    ...
                    <Col lg="2">
                      <p>Followers</p>
                      <p style={{ fontWeight: "bold" }}>1,239</p>
                    </Col>
                    <Col lg="2">
                      <p>Following</p>
                      <p style={{ fontWeight: "bold" }}>528</p>
                    </Col>
                    <Col lg="4">
              ...
              <Row>
                ...
                <Col md={6} className="introContainer">
                  ...
                  <div className="postReview">
                    ...
                    <h4>This is Egypt </h4>
                    <p>
                      the pyramids are huge and it was so hot there sand i liked
                      the indide there are stone creatures there are fake doors
                      there are lotsof atractons there
                    </p>
                  </div>
                </Col>
                <Col md={1}></Col>
